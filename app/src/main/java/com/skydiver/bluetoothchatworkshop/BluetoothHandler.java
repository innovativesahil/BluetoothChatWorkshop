 ...
 * connections with other devices. It has a thread that connects with a device, and a
...
public class BluetoothHandler {
    ...
    /**
     * Constructor. Prepares a new Bluetooth chat session.
     *
    ...
    public void write(byte[] out) {
        ...
        Log.e("State in write()", String.valueOf(mState));
...
//                    tmp = mAdapter.listenUsingRfcommWithServiceRecord(NAME_SECURE, MY_UUID_SECURE);
                tmp = mAdapter.listenUsingInsecureRfcommWithServiceRecord(SERVICE_NAME, MY_UUID);
